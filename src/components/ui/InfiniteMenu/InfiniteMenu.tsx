...
function createAndSetupTexture(
  gl: WebGL2RenderingContext,
  minFilter: number, magFilter: number, wrapS: number, wrapT: number
) {
...
class InfiniteGridMenu {
  ...
  constructor(
    ...
    private onMovementChange: (active: boolean) => void,
  ...
  private init(onInit: ((sketch: InfiniteGridMenu) => void) | null) {
    ...
    this.discVAO = makeVertexArray(
      gl,
      [
        [makeBuffer(gl, this.discBuffers.vertices as unknown as BufferSource, gl.STATIC_DRAW), this.discLocations.aModelPosition as number, 3],
        [makeBuffer(gl, this.discBuffers.uvs as unknown as BufferSource, gl.STATIC_DRAW), this.discLocations.aModelUvs as number, 2],
      ],
