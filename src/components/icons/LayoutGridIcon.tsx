...
export function LayoutGridIcon({ size = 24, className }: Props) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <rect x="3" y="3" width="18" height="7" rx="1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
